...
*/
const BotName = 'Bot F e b b'; // Nama Bot Whatsapp
...
const grupch1 = 'Cooming Soon'; // OFFICIAL GRUP LU 1
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] SCAN QR NYA SEKARANG!`);
});
...
conn.sendMessage(id, '╭───「 *Sosmed Owner* 」/n├≽ ️Instagram : instagram.com/febby28_/n├≽ ️WhatsApp : wa.me/6285770269605/n─────────' ,MessageType.text);
}
else if (text == 'Febb'){
conn.sendMessage(id, '#help aja ketik_-' ,MessageType.text);
}
else if (text == 'oi'){
