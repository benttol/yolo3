...
*/
const BotName = 'Bot Febb'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/febby28_'; // Nama Instagramlu cok
...
const grupch3 = 'https://instagram.com/febby28_'; // OFFICIAL GRUP LU 3
//
...
conn.sendMessage(id, 'https://st4rz.herokuapp.com/api/randomloli' ,MessageType.image);
}
else if (text == '!owner'){
conn.sendMessage(id, '*_Owner Bot Febb : wa.me/6285770269605_*' ,MessageType.text);
}
else if (text == '!grupwa'){
...
axios.get(`https://st4rz.herokuapp.com/api/chord?q=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] Searching...⏳', MessageType.text)
    let hasil = `*Nih Chord Lagu ${teks} kak* \n\nCord: _${res.data.result}_ `;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://mhankbarbar.herokuapp.com/api/fb?link=${teks}&apiKey=lGjYt4zA5SQlTDx9z9Ca`).then((res) => {
...
_${kata}_
   ...
   if (text.includes("!hentai"))
   {
    ...
    var url = "https://mhankbarbar.herokuapp.com/api/random/hentai?apiKey=lGjYt4zA5SQlTDx9z9Ca="+ hentai;
    
    axios.get(url)
      .then((result) => {
        var b = JSON.parse(JSON.stringify(result.data));
        var anim =  b[Math.floor(Math.random() * b.length)];
        imageToBase64(hentai) // Path to the image
        .then(
            (response) => {
   ...
   if (text.includes("!loli"))
   {
    ...
    var url = "https://st4rz.herokuapp.com/api/randomloli="+ loli;
